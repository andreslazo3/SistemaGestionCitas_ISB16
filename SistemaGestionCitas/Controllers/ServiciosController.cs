...
namespace SistemaGestionCitas.Controllers
{
    ...
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreServicio,Descripcion,DuracionMinutos,Costo,Activo")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NombreServicio,Descripcion,DuracionMinutos,Costo,Activo")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
